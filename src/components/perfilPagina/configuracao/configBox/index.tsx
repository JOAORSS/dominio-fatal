...
const perfilDictionary = {
    "editar": {image: <LiaUserEditSolid {...reacIconsProps} />, link: "/perfil/editar", titulo: "Atualizar dados da conta", descricao: "Atualizar dados relativos a conta, nome, telefone, endereco..."},
...
export default function ConfigBox({ typePerfil } : ConfigBoxProps) {
    ...
    return (
        <button onClick={() => router.push(perfilDictionary[typePerfil].link)} className={styles.configBox}>
            ...
            <Link className={styles.configSeta} href={perfilDictionary[typePerfil].link}><IoArrowForwardCircleOutline {...reacIconsProps} /></Link>
        </button>
    )
}